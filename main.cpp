...
int main() {
    ...
    SIZE_T memInitializeDataBefore = getCurrentMemoryUsage();
    ...
    SIZE_T memInitializeDataAfter = getCurrentMemoryUsage();
    cout << "Memory used: " << (memInitializeDataAfter - memInitializeDataBefore) / 1024 << " KB" << endl;
